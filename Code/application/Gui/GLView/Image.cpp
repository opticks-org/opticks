...
private:
   ...
   void createGrayscale(T* pData, ComplexComponent component)
   {
      ...
      bool hasSingleBadValue = false;
      if (hasBadValues)
      {
          hasSingleBadValue = mInfo.mKey.mpBadValues1->getSingleBadValueRange(singleBadValueLower, singleBadValueUpper);
      }
