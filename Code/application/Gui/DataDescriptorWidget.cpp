...
void DataDescriptorWidget::initialize()
{
   ...
   // Signature data descriptor item
...
QTreeWidgetItem* DataDescriptorWidget::getDescriptorItem(const QString& strName, QTreeWidgetItem* pStartAt) const
{
   if (strName.isEmpty())
   {
      return NULL;
