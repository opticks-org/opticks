...
ADD_ENUM_MAPPING(FRAME_ELAPSED_TIME, "Elapsed Time", "elapsedTime")
END_ENUM_MAPPING()
...
ADD_ENUM_MAPPING(GEOCOORD_LATLON, "Latitude/Longitude", "Lat/Lon")
...
BEGIN_ENUM_MAPPING(InterpolationType)
ADD_ENUM_MAPPING(INTERP_NEAREST_NEIGHBOR, "Nearest Neighbor", "Nearest Neighbor");
ADD_ENUM_MAPPING(INTERP_BILINEAR, "Bilinear", "Bilinear");
ADD_ENUM_MAPPING(INTERP_BICUBIC, "Bicubic", "Bicubic");
ADD_ENUM_MAPPING(INTERP_AREA, "Area", "Area");
ADD_ENUM_MAPPING(INTERP_LANCZOS4, "Lanczos4", "Lanczos4");
END_ENUM_MAPPING()
