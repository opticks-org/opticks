...
TYPECONVERTERTOSTRING_IMP_FORWARD(BadValues)
...
TYPECONVERTERTOSTRING_IMP_FORWARD(GeoreferenceDescriptor)
...
TYPECONVERTERTOSTRING_IMP(Opticks::PixelOffset)
TYPECONVERTERTOSTRING_IMP_FORWARD(PlotView)
TYPECONVERTERTOSTRING_IMP_FORWARD(PlotWidget)
TYPECONVERTERTOSTRING_IMP_FORWARD(PointCloudDataDescriptor)
TYPECONVERTERTOSTRING_IMP_FORWARD(PointCloudDataRequest)
TYPECONVERTERTOSTRING_IMP_FORWARD(PointCloudElement)
TYPECONVERTERTOSTRING_IMP_FORWARD(PointCloudFileDescriptor)
TYPECONVERTERTOSTRING_IMP_FORWARD(PointCloudView)
TYPECONVERTERTOSTRING_IMP_FORWARD(PointCloudWindow)
