...
protected:
    ...
    *
    *  Since it assumes that the XPM is declared local to the plug-in,
    *  ExecutableShell does not have ownership over the the pointer.
    *  Because of this, the subclass must do its own memory management for the icon. 
    *
    *  @param   pIcon
