...
find_library(Hdf4_LIBRARY_RELEASE NAMES hd${Hdf4_COMPACT_VERSION_STRING}m hdf df dfalt PATHS /usr/lib64/hdf)
...
if(NOT SD_FOUND_INDEX EQUAL -1)
    ...
    find_library(Hdf4_SD_LIBRARY_DEBUG NAMES hm${Hdf4_COMPACT_VERSION_STRING}md mfhdfd PATHS /usr/lib64/hdf)
...
if(Hdf4_FOUND)
   message(STATUS "Found Hdf4: ${Hdf4_INCLUDE_DIRS} ${Hdf4_LIBRARIES}")
endif()
