...
if(OpenJpeg_FOUND)
   ...
   # Eventually we shouldn't need this if we can work around openjpeg's current lack of opj_stream_seek_stream()
   ...
   if(NOT OpenJpeg_opj_stream_seek_stream)
      ...
      add_definitions(-DOPJ_STREAM_SEEK_STREAM_NOTFOUND=1)
   else()
      message(STATUS "OpenJpeg_opj_stream_seek_stream FOUND")
