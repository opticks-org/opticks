...
namespace Opticks
{
    ...
    */
   class PixelLocation : public Location<unsigned int, 2>
   {
   public:
      using Location<unsigned int, 2>::Location;

      PixelLocation() : PixelLocation(0, 0) {}
      PixelLocation(const Location<unsigned int, 2>& other) : PixelLocation(other.mX, other.mY) {}
   };

   /**
    * This represents a pixel offset in cube or screen coordinates.
    */
   class PixelOffset : public Location<int, 2>
   {
   public:
      using Location<int, 2>::Location;

      PixelOffset() : PixelOffset(0, 0) {}
      PixelOffset(const Location<int, 2>& other) : PixelOffset(other.mX, other.mY) {}
   };
 ...
 */
template<> class VariantTypeValidator<Opticks::PixelLocation> {};
template<> class VariantTypeValidator<const Opticks::PixelLocation> {};
template<> class VariantTypeValidator<Opticks::PixelOffset> {};
template<> class VariantTypeValidator<const Opticks::PixelOffset> {};
/// \endcond
