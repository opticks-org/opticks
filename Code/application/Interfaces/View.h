...
public:
   ...
   /**
    *  Emitted with boost::any<const \link Classification\endlink*> when the
    *  classification changes.
    *
    *  @see     signalClassificationTextChanged(), setClassification()
    */
   SIGNAL_METHOD(View, ClassificationChanged)

   /**
    *  Emitted when the displayed classification text changes as a result of a
    *  classification change with boost::any<std::string> containing the new
    *  classification text.
    *
    *  This signal will not always be emitted when the
    *  signalClassificationChanged() signal is emitted as a result of a
    *  classification change, if the modified classification parameters do not
    *  appear in the displayed text.
    *
    *  @see     signalClassificationChanged(), setClassification()
    */
   SIGNAL_METHOD(View, ClassificationTextChanged)
    ...
    *           The classification for the view.  A deep copy is performed so it
    *           is the responsibility of the calling object to delete the given
    *           Classification object when necessary.  This method does nothing
    *           if \c NULL is passed in.
    *
    *  @notify  This method will notify signalClassificationChanged() with
    *           boost::any<const \link Classification\endlink*> if the
    *           classification changes.  This method will also notify
    *           signalClassificationTextChanged() with boost::any<std::string>
    *           containing the new classification that that will be displayed
    *           only if the text generated by the given classification has
    *           changed from the previously displayed classification text.
    */
